...
%
% Original authors: Pim van der Male & Dominik Fallais

% Edited to accomodate current case. Modifications can be found with cntr+F and
% Edit
% -------------------------------------------------------------------------
...
[K,M] = asmkm(Nodes,Elements,Types,Sections,Materials,DOF); % StaBIL function

% Add top mass
tmDOF = Ntt + 0.01;                     % [Ntt + 0.01, Ntt + 0.03;]
[~,Mtm] = selectdof(DOF,tmDOF); % StaBIL function
...
[Phi,Omega] = eigfem(K,M); % StaBIL function
